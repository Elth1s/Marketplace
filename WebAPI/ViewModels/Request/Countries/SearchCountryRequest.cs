...
namespace WebAPI.ViewModels.Request.Countries
{
    ...
    /// <summary>
    /// Class for <seealso cref="SearchCountryRequest" /> validation
    /// </summary>
    public class SearchCountryRequestValidator : AbstractValidator<SearchCountryRequest>
    {
        public SearchCountryRequestValidator()
        {
            //Page
