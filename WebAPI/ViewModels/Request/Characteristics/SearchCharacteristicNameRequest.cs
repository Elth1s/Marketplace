...
{
    /// <summary>
    /// Characteristic name class to create and update country 
    /// </summary>
    public class SearchCharacteristicNameRequest
    {
        /// <summary>
        /// Page
        /// </summary>
    ...
    /// <summary>
    /// Class for <seealso cref="SearchCharacteristicNameRequest" /> validation
    /// </summary>
    public class SearchCharacteristicNameRequestValidator : AbstractValidator<SearchCharacteristicNameRequest>
    {
        public SearchCharacteristicNameRequestValidator()
        {
            //Page
