...
const CountryTable = () => {
    ...
    const [orderBy, setOrderBy] = useState<keyof IUnitInfo>('id');

    const [selected, setSelected] = useState<readonly number[]>([]);

    const { SearchUnits, DeleteUnits } = useActions();
    ...
    const getData = async () => {
        try {
            await SearchUnits(page, rowsPerPage, name, isAscOrder, orderBy);
            setSelected([]);
        } catch (ex) {
        }
    };
                    ...
                    units.map((row, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <TableCellStyle align="center">{row.measure}</TableCellStyle>
                            </TableRow>
                        );
                    })
                }
