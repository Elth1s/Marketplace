...
const ProductReviewsPage: FC<Props> = ({ addInCart }) => {
    ...
    return (
        <>
            <Typography variant="h1" color="inherit" sx={{ mt: "30px", mb: "15px" }}>{questions.length !== 0 ? t("pages.product.menu.questions") : t("pages.product.menu.leaveQuestions")} {product.name}</Typography>
                            ...
                            <Box sx={{ display: "flex", mt: "26px", alignItems: "center" }}>
                                ...
                                <Typography variant="h4" color="inherit" fontWeight="bold" display="inline">
                                    ...
                                    <Typography color="inherit" fontWeight="medium" display="inline" sx={{ fontSize: "20px" }}>
                                        ({productRating.countReviews} {t("pages.product.ratings")})</Typography>
                                </Typography>
                            </Box>
                            {product.isInBasket
