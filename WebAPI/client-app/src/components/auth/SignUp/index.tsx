...
const SignUp = () => {
    ...
    const registerModel: IRegisterModel = { firstName: '', secondName: '', email: '', phone: '', password: '', confirmPassword: '' };
        ...
        <Grid container >
            ...
            <Grid item xs={12} sm={12} md={7} lg={5}>
                ...
                >
                    ...
                    <Typography component="h4" variant="h4" mt={1.5} >
                        Sign Up
                    </Typography>
                    <Box sx={{ mt: 1 }} >
                            ...
                            <Form autoComplete="off" noValidate onSubmit={handleSubmit} >
                                ...
                                <Grid sx={{ p: 5, }} container spacing={4}>
                                    ...
                                    <Grid item xs={12} mt={3} display="flex" justifyContent="flex-end">
                                        <Typography >
                                            Already have an account? <Typography component={Link} variant="h6" style={{ textDecoration: 'none' }} to="/auth/signin">Sign In.</Typography>
                                        </Typography>
                                    </Grid>
                                </Grid>
