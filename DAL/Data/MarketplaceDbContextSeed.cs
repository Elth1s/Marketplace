...
/*25*/          new(){ Name = "Carnival costumes", UrlSlug = "carnival-costumes", Image = "", ParentId = 3},
/*26*/          new(){ Name = "Ethnic clothing", UrlSlug = "ethnic-clothing", Image = "", ParentId = 3},

/*27*/          new(){ Name = "Computer equipment and software", UrlSlug = "computer-equipment-and-software", Image = "", ParentId = 4},
/*28*/          new(){ Name = "Household appliances", UrlSlug = "household-appliances", Image = "", ParentId = 4},
/*29*/          new(){ Name = "Phones and accessories", UrlSlug = "phones-and-accessories", Image = "", ParentId = 4},
/*30*/          new(){ Name = "Audio equipment and accessories", UrlSlug = "audio-equipment-and-accessories", Image = "", ParentId = 4},
/*31*/          new(){ Name = "Spare parts for machinery and electronics", UrlSlug = "spare-parts-for-machinery-and-electronics", Image = "", ParentId = 4},
/*32*/          new(){ Name = "TV and video equipment", UrlSlug = "tv-and-video-equipment", Image = "", ParentId = 4},
/*33*/          new(){ Name = "Car electronics", UrlSlug = "car-electronics", Image = "", ParentId = 4},
/*34*/          new(){ Name = "Photos, camcorders and accessories", UrlSlug = "photos-camcorders-and-accessories", Image = "", ParentId = 4},
/*35*/          new(){ Name = "3d devices", UrlSlug = "3d-devices", Image = "", ParentId = 4},
/*36*/          new(){ Name = "Equipment for satellite internet", UrlSlug = "equipment-for-satellite-internet", Image = "", ParentId = 4},

/*37*/          new(){ Name = "Tablet computers", UrlSlug = "tablet-computers", Image = "", ParentId = 27},
/*38*/          new(){ Name = "Laptops", UrlSlug = "laptops", Image = "", ParentId = 27},
/*39*/          new(){ Name = "Monitors", UrlSlug = "monitors", Image = "", ParentId = 27},
/*40*/          new(){ Name = "Components for computer equipment", UrlSlug = "components-for-computer-equipment", Image = "", ParentId = 27},
/*41*/          new(){ Name = "Computer accessories", UrlSlug = "computer-accessories", Image = "", ParentId = 27},
/*42*/          new(){ Name = "Smart watches and fitness bracelets", UrlSlug = "smart-watches-and-fitness-bracelets", Image = "", ParentId = 27},
/*43*/          new(){ Name = "Printers, scanners, MFPs and components", UrlSlug = "printers-scanners-mfps-and-components", Image = "", ParentId = 27},
/*44*/          new(){ Name = "Information carriers", UrlSlug = "information-carriers", Image = "", ParentId = 27},
/*45*/          new(){ Name = "Game consoles and components", UrlSlug = "game-consoles-and-components", Image = "", ParentId = 27},
/*46*/          new(){ Name = "Desktops", UrlSlug = "desktops", Image = "", ParentId = 27},
/*47*/          new(){ Name = "Software", UrlSlug = "software", Image = "", ParentId = 27},
/*48*/          new(){ Name = "Server equipment", UrlSlug = "server-equipment", Image = "", ParentId = 27},
/*49*/          new(){ Name = "Mining equipment", UrlSlug = "mining-equipment", Image = "", ParentId = 27},
/*50*/          new(){ Name = "E-books", UrlSlug = "e-books", Image = "", ParentId = 27},
/*51*/          new(){ Name = "Single board computers and nettops", UrlSlug = "single-board-computers-and-nettops", Image = "", ParentId = 27},
/*52*/          new(){ Name = "Portable electronic translators", UrlSlug = "portable-electronic-translators", Image = "", ParentId = 27},

                new(){ Name = "Cables for electronics", UrlSlug = "cables-for-electronics", Image = "", ParentId = 40},
                new(){ Name = "HDD, SSD", UrlSlug = "hdd-ssd", Image = "", ParentId = 40},
                new(){ Name = "Batteries for laptops, tablets, e-books, translators", UrlSlug = "batteries-for-laptops-tablets-e-books-translators", Image = "", ParentId = 40},
                new(){ Name = "Laptop chargers", UrlSlug = "laptop-chargers", Image = "", ParentId = 40},
                new(){ Name = "Laptop body parts", UrlSlug = "laptop-body-parts", Image = "", ParentId = 40},
                new(){ Name = "Memory modules", UrlSlug = "memory-modules", Image = "", ParentId = 40},
                new(){ Name = "Processors", UrlSlug = "processors", Image = "", ParentId = 40},
                new(){ Name = "Coolers and cooling systems", UrlSlug = "coolers-and-cooling-systems", Image = "", ParentId = 40},
                new(){ Name = "Matrixes for laptops, tablets and monitors", UrlSlug = "matrixes-for-laptops-tablets-and-monitors", Image = "", ParentId = 40},
                new(){ Name = "Cables and connectors for laptops, computers, tablets", UrlSlug = "cables-and-connectors-for-laptops-computers-tablets", Image = "", ParentId = 40},
                new(){ Name = "Keyboard blocks for laptops", UrlSlug = "keyboard-blocks-for-laptops", Image = "", ParentId = 40},
                new(){ Name = "Touchscreen for displays", UrlSlug = "touchscreen-for-displays", Image = "", ParentId = 40},
                new(){ Name = "Microcircuits", UrlSlug = "microcircuits", Image = "", ParentId = 40},
                new(){ Name = "Spare parts for TVs and monitors", UrlSlug = "spare-parts-for-tvs-and-monitors", Image = "", ParentId = 40},
                new(){ Name = "Motherboards", UrlSlug = "motherboards", Image = "", ParentId = 40},
                new(){ Name = "Video cards", UrlSlug = "video-cards", Image = "", ParentId = 40},
                new(){ Name = "Enclosures for computers", UrlSlug = "enclosures-for-computers", Image = "", ParentId = 40},
                new(){ Name = "Power supplies for computers", UrlSlug = "power-supplies-for-computers", Image = "", ParentId = 40},
                new(){ Name = "Patch cord", UrlSlug = "patch-cord", Image = "", ParentId = 40},
                new(){ Name = "Pockets for hard drives", UrlSlug = "pockets-for-hard-drives", Image = "", ParentId = 40},
                new(){ Name = "Adapters and port expansion cards", UrlSlug = "adapters-and-port-expansion-cards", Image = "", ParentId = 40},
                new(){ Name = "Audio parts for laptops", UrlSlug = "audio-parts-for-laptops", Image = "", ParentId = 40},
                new(){ Name = "Thermal paste", UrlSlug = "thermal-paste", Image = "", ParentId = 40},
                new(){ Name = "Sound cards", UrlSlug = "sound-cards", Image = "", ParentId = 40},
                new(){ Name = "Network cards", UrlSlug = "network-cards", Image = "", ParentId = 40},
                new(){ Name = "Optical drives", UrlSlug = "optical-drives", Image = "", ParentId = 40},
                new(){ Name = "Cases for tablets", UrlSlug = "cases-for-tablets", Image = "", ParentId = 40},
                new(){ Name = "Accessories for matrices and displays", UrlSlug = "accessories-for-matrices-and-displays", Image = "", ParentId = 40},
                new(){ Name = "Cameras for laptops", UrlSlug = "cameras-for-laptops", Image = "", ParentId = 40},
                new(){ Name = "Cooling systems for laptops", UrlSlug = "cooling-systems-for-laptops", Image = "", ParentId = 40},
                new(){ Name = "TV and FM tuners", UrlSlug = "tv-and-fm-tuners", Image = "", ParentId = 40},
                new(){ Name = "Postcards", UrlSlug = "postcards", Image = "", ParentId = 40},
                new(){ Name = "Accessories for routers", UrlSlug = "accessories-for-routers", Image = "", ParentId = 40},
