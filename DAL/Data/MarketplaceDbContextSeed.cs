...
namespace DAL.Data
{
    public class MarketplaceDbContextSeed
    {
            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            await userManager.AddToRoleAsync(defaultUser1, Roles.Seller);
            ...
            defaultUser2 = await userManager.FindByEmailAsync(UsersInfo.DefaultEmailSecond);
            await userManager.AddToRoleAsync(defaultUser2, Roles.Seller);
            ...
            var Laptop = marketplaceDbContext.Categories.Where(c => c.Id == 21).FirstOrDefault();
            ...
            defaultUser1.ShopId = 1;
            await userManager.UpdateAsync(defaultUser1);
            defaultUser2.ShopId = 2;
            await userManager.UpdateAsync(defaultUser2);
            ...
            if (!await marketplaceDbContext.FilterValues.AnyAsync())
            {
                await marketplaceDbContext.FilterValues.AddRangeAsync(
                  GetPreconfiguredMarketplaceFilterValues(WomensClothes, Laptop));
...
/*-4- 12*/      new(){ FilterGroupId=4,
        ...
        static IEnumerable<FilterValue> GetPreconfiguredMarketplaceFilterValues(Category categoryDress, Category categoryLaptop)
        {
